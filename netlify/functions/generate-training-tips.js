...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        if (canGenerate) {
            ...
            const prompt = `Crie uma dica de treino para iniciantes, com um título cativante e um conteúdo de cerca de 5-7 parágrafos. A dica deve ser prática e motivadora. Exemplo de tema: "Como começar a correr: um guia para iniciantes".`;
